...
// Crear usuarios
export async function CrearUsuario({ nombre, apellido1, apellido2, cargo, municipalidad, correo, contrasena, num_tel, id_rol }) {
...
export async function ObtenerUsuarios() {
    const pool = await connectDB();
    const result = await pool.request()
        .query("SELECT id_usuario, nombre, apellido1, apellido2, cargo, municipalidad, correo, num_tel, id_rol FROM Usuario");
...
export async function ObtenerUsuarioPorId(id_usuario) {
    ...
    const result = await pool.request()
        ...
        .query("SELECT id_usuario, nombre, apellido1, apellido2, cargo, municipalidad, correo, num_tel, id_rol FROM Usuario WHERE id_usuario = @id_usuario");
    return result.recordset[0];
}

// Actualizar usuarios
export async function ActualizarUsuario(id_usuario, { nombre, apellido1, apellido2, cargo, municipalidad, correo, contrasena, num_tel, id_rol }) {
    const pool = await connectDB();
